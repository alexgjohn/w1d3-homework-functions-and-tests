...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    ...
    self.assertEqual(27, volume_of_cube_result)


  #Given a String, return the String reversed

  def test_reverse_string(self):
    reverse_string_result = reverse_string("hello")
    self.assertEqual("olleh", reverse_string_result)
  ...
  def test_fahrenheit_to_celsius(self):
    fahrenheit_to_celsius_result = fahrenheit_to_celsius(7)
    self.assertEqual(-13.88888888888889, fahrenheit_to_celsius_result)
